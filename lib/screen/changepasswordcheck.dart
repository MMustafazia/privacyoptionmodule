...
import 'package:privacyoption/screen/changepasswordscreen.dart';
import 'package:shared_preferences/shared_preferences.dart';

class ChangePasswordCheckScreen extends StatefulWidget {
  const ChangePasswordCheckScreen({super.key});

  @override
  State<ChangePasswordCheckScreen> createState() =>
      _ChangePasswordCheckScreenState();
}

class _ChangePasswordCheckScreenState extends State<ChangePasswordCheckScreen> {
